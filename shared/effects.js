...
// honest either way.
// A record's id names the document that published it — `srd_2_0_domain_card_vitality`. Vitality is
// the same card in every edition that prints it, so a key is tried as given and then with that
// document prefix removed, and one catalogue entry serves them all. bareForms() does the stripping
