...
// go stale the first time a field was added. The guard is what makes that safe — a string is only
...
const COLLECTIONS = ["classes", "subclasses", "ancestries", "communities", "transformations",
  "domainCards", "weapons", "armors", "consumables", "stances", "beastforms", "companionOptions"];
