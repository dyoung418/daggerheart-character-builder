...
- `shared/advancement.js`, `history.js`, `derived-stats.js`, `effects.js`, `sheet-data.js`,
  `table-state.js`, `transfer.js`, `portrait.js`, `gear.js`, `i18n.js`, `choice-keys.js`,
  `csv-export.js`, `content-sources.js`, `pdf.js`, `pdf-form.js`, `card-layout.js`,
  `card-sheet.js`, `card-content.js`, `sheet-fields.js`, `text.js` — no DOM. Tested.
...
this repository.** `data/<source>/card-art/` is git-ignored and the renderer falls back to a CSS-only
